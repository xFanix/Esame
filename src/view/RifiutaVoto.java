...
public class RifiutaVoto extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public RifiutaVoto(JFrame owner, boolean modal) {
		super(owner, modal);
		setTitle("Rifiuta Voto");
		...
		JLabel lblStaiPerCancellare = new JLabel("Stai per rifiutare questo voto \r\n");
