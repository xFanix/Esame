...
public class ConfermaPrenotazione extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ConfermaPrenotazione(JFrame owner, boolean modal) {
		super(owner, modal);
		...
		JLabel lblStaiPerCancellare = new JLabel("Stai per confermare la prenotazione \r\n");
